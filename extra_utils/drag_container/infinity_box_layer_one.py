...
class InfinityBoxLayerOne(ft.UserControl):
     ...
     def build(self):
          ...
          self.widgets={
               ...
               ####################### CONTAINERS LAYOUTS
                       ...
                       "Row": [    ft.Container(bgcolor='#5f0f87ff',alignment=ft.alignment.center,padding=ft.padding.all(4),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Row',
                    ...
                    "Column": [    ft.Container(bgcolor='#5f5f0000',alignment=ft.alignment.center,padding=ft.padding.all(4),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Column',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                     ...
                     "Stack": [    ft.Container(bgcolor='#d75f0fd700',alignment=ft.alignment.center,padding=ft.padding.all(4),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Stack',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.Stack(
                                        controls= [
                  ...
                  "GridView": [    ft.Container(bgcolor='#5f5d000fff',alignment=ft.alignment.center,border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='GridView',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
               ...
               ####################### SPACE LAYOUTS
                   "Divider": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Divider',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.Divider(),),
                              ],
                              # VerticalDivider most set propertie [container height ] becouse no work onVerticalDivider
                  "Vertical": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),height=25,margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='VerticalDivider',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
               ...
               ####################### IMAGE WIDGET
                     "Image": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Image',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.Image(src=f'image.jpg',fit=ft.ImageFit.FILL,width=110,height=110,tooltip='Image'),),
                              ],
                    "Avatar": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Avatar',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                      ...
                      "Icon": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Icon',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.Icon(name=ft.icons.ADD_REACTION_OUTLINED,tooltip='Icon'),),
                              ],
               ####################### TEXT  WIDGET
                     "Text":  [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Text',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.Text(value="Text",tooltip='Text'),),
                              ],
                "Text Field": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(4),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='TextField',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.TextField(label="TextField",tooltip='TextField',border_radius= ft.border_radius.all(30),height=40, cursor_height=20,content_padding= ft.padding.all(16),),),
                              ],

               ####################### BUTTONS WIDGET

           "Elevated Button": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='ElevatedButton',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.ElevatedButton("Elevated Button",tooltip='ElevatedButton'),),
                              ],
               "Text Button": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='TextButton',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.TextButton("Text Button",tooltip='TextButton'),),
                              ],
               "Icon Button": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='IconButton',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.IconButton(tooltip='Icon Button',icon=ft.icons.ADD_LINK_SHARP),),
                              ],
                    "Filled": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='FilledButton',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.FilledButton("Filled Button",tooltip='FilledButton'),),
                              ],
                     "Tonal": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='FilledTonalButton',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.FilledTonalButton("Filled Tonal Button",tooltip='FilledTonalButton'),),
                              ],
                   "Outline": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='OutlinedButton',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
               ...
               ####################### SELECTIONS WIDGET
                 "Checkbox":  [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(6),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Checkbox',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.Checkbox(label="  Checkbox",tooltip='Checkbox',value=False),),
                              ],
                 "Cupertino": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='CupertinoCheckbox',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.CupertinoCheckbox(label="Cupertino Checkbox",tooltip='CupertinoCheckbox',value=False),),
                              ],
                    "Switch": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(12),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Switch',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.Switch(label="    Cupertino Switch",tooltip='Switch',value=False),),
                              ],

                      "Chip": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Chip',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.Chip(label=ft.Text("Chip"), leading=ft.Icon(ft.icons.CAMERA_ROUNDED),tooltip='Chip'),),
                              ],

                    "Slider": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(0),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='CupertinoRadio',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                 ...
                 "Cup Radio": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(12),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='CupertinoRadio',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
                                   content=ft.RadioGroup(content=ft.CupertinoRadio(label="    Cupertino Radio",tooltip='CupertinoRadio',value=False),),),
                              ],

                     "Radio": [    ft.Container(bgcolor=ft.colors.BLACK12,alignment=ft.alignment.center,padding=ft.padding.all(12),margin=ft.margin.all(0),border=ft.border.all(0.8, ft.colors.BLACK12),tooltip='Radio',
                                   on_hover=lambda _:self.resetClick(),
                                   on_click=lambda _:self.touchWidgetIndex(self.infinityDropWidget),
     ...
     def drag_accept(self,widgetDropBox):
          ...
          widgetDropBox.control.content.border = ft.border.all(2, ft.colors.BLACK12)
