        ...
        self.widgets = {
            ...
            "Icon": [
                ft.Container(
                    ...
                    on_click=lambda _: self.touchWidgetIndex(self.infinityDropWidget),
                    content=ft.Icon(
                        name=ft.icons.ADD_REACTION_OUTLINED, tooltip="Icon"
                    ),
                ),
            ],
            #: TEXT  WIDGET
            ...
            "Elevated Button": [
                ft.Container(
                    ...
                    content=ft.ElevatedButton(
                        "Accept", tooltip="ElevatedButton", elevation=20, height=28
                    ),
                ),
            ],
            "Text Button": [
            ...
            "Icon Button": [
                ft.Container(
                    ...
                    content=ft.IconButton(
                        tooltip="Accept", icon=ft.icons.ADD_LINK_SHARP
                    ),
                ),
            ],
            "Filled": [
                ft.Container(
                    ...
                    margin=ft.margin.all(0),
                    border=ft.border.all(0, ft.colors.TRANSPARENT),
                    tooltip="FilledButton",
                    ink=True,
                    ink_color="red",
                    on_hover=lambda _: self.resetClick(),
                    on_click=lambda _: self.touchWidgetIndex(self.infinityDropWidget),
                    content=ft.FilledButton(
                        "Accept", tooltip="FilledButton", height=28
                    ),
                ),
            ],
            "Tonal": [
                ft.Container(
                    ...
                    margin=ft.margin.all(0),
                    border=ft.border.all(0, ft.colors.TRANSPARENT),
                    tooltip="FilledTonalButton",
                    ink=True,
                    ink_color="red",
                    on_hover=lambda _: self.resetClick(),
                    on_click=lambda _: self.touchWidgetIndex(self.infinityDropWidget),
                    content=ft.FilledTonalButton(
                        "Accept", tooltip="FilledTonalButton", height=28
                    ),
                ),
            ],
            "Outline": [
                ft.Container(
                    ...
                    margin=ft.margin.all(0),
                    border=ft.border.all(0, ft.colors.TRANSPARENT),
                    tooltip="OutlinedButton",
                    ink=True,
                    ink_color="red",
                    on_hover=lambda _: self.resetClick(),
                    on_click=lambda _: self.touchWidgetIndex(self.infinityDropWidget),
                    content=ft.OutlinedButton(
                        "Accept", tooltip="OutlinedButton", height=28
                    ),
                ),
            ],
            #: SELECTIONS WIDGET
            ...
            "Chip": [
                ft.Container(
                    ...
                    content=ft.Chip(
                        ...
                        leading=ft.Icon(ft.icons.CAMERA_ROUNDED),
                        tooltip="Chip",
            ...
            "Slider": [
                ft.Container(
                    ...
                    on_hover=lambda _: self.resetClick(),
                    on_click=lambda _: self.touchWidgetIndex(self.infinityDropWidget),
                    content=ft.CupertinoSlider(
                        tooltip="CupertinoSlider",
                        max=100,
                        height=28,
                    ),
                ),
...
=======
        ...
        self.infinityDropWidget[
            0
        ].tooltip = f"{self.dataPassed}: {numWidget}"  # TOOLTIP ID
...
<<<<<<< HEAD
          ...
          #: print(self.infinityDropWidget[0].id)
          #: print(self.infinityDropWidget[0]._Control__uid)
          # print(self.infinityDropWidget[0].__dict__,'<<<<<<<<<<<<<<<<<<')
...
<<<<<<< HEAD
          ...
          # print(self.drag_boxs.content.content.__dict__)
          return self.drag_boxs
=======
    def resetClick(self):
        global numClick
...
>>>>>>> 102af40 (fixed overlay append)
    ...
    def touchWidgetIndex(self, listWidget):
        ...
        last_click_time = GLOBAL_VAR(
            get_global_var="CHECK_CURRENT_TIME_DOBLE_CLICKS"
        )  # < == DEFAULD 0
        ...
        if (click_time - last_click_time) < 0.3:
            ...
            if CHECK_DATA:
                ...
                CONFIG_TABS_CONTAINERS = GLOBAL_VAR(
                    get_global_var="CONFIG_TABS_CONTAINERS"
                )
            ...
            if numClick == 1:
                ...
                TEXT_PHONE_WIDGET = GLOBAL_VAR(
                    get_global_var="SHOW_TEXT_SELECTED_PHONE_WIDGET"
                )
                TEXT_PHONE_WIDGET.controls[0].content.controls[1].spans[
                    0
                ].text = listWidget[0].tooltip
                TEXT_PHONE_WIDGET.controls[0].bgcolor = ft.colors.BLUE_GREY_900
                TEXT_PHONE_WIDGET.controls[0].update()

                TEXT_DRAGG_WIDGET = GLOBAL_VAR(
                    get_global_var="SHOW_TEXT_SELECTED_DRAGG_WIDGET"
                )
                ...
                GLOBAL_VAR(
                    set_global_var={"SELECT_DROPP_WIDGET_CONTAINER": listWidget[0]}
                )
                GLOBAL_VAR(
                    set_global_var={
                        "SELECT_DROPP_WIDGET_CONTAINER_CONTENT": listWidget[0].content
                    }
                )
                ...
                GLOBAL_VAR(
                    set_global_var={"CHECK_CURRENT_TIME_DOBLE_CLICKS": click_time}
                )  # <==== TO CHECK CLICKS SCAPED IN CONTAINERS
    ...
    def drag_accept(self, widgetDropBox):
        ...
        if selectWidgetBox in self.widgetFilter:
            ...
            if right_content in self.widget_Filter:
                ...
                widgetDropBox.control.content.content.controls.append(
                    self.InstanceNewWidget
                )
            # else:
            #      pass
