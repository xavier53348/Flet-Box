...
class SmallPaleteColor(ft.Container):
    ...
    def modify_widget(self):
        ...
        #: SET ATTRIBUTES
        if self.widget_tag_name == "bgcolor":
            self.widget.bgcolor = self.pallete_color
        if self.widget_tag_name == "focused_bgcolor":
            self.widget.focused_bgcolor = self.pallete_color
        if self.widget_tag_name == "border_color":
            self.widget.border_color = self.pallete_color
        if self.widget_tag_name == "focused_border_color":
            self.widget.focused_border_color = self.pallete_color
        if self.widget_tag_name == "color":
            self.widget.color = self.pallete_color
        if self.widget_tag_name == "icon_color":
            self.widget.icon_color = self.pallete_color
        if self.widget_tag_name == "check_color":
            self.widget.check_color = self.pallete_color
        if self.widget_tag_name == "fill_color":
            self.widget.fill_color = self.pallete_color
