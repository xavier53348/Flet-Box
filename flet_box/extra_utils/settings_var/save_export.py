...
class MakeJasonFile():
    ...
    def build_json_file(self,widget_show):
        ...
        NOTE: THIS MODULE IS A NESTED DICT WITH FOR LOOPS WALKING TROUGHT CONTAINER ROW ... WIDGETS
        AND REBUILD ALL IN TO FILES TAKE ATTRIBUTES AND CONTENT OR CONTROLS INSIDE WIDGET MAKING ALL
        TO ONE CODE EACH PAGE IS ONE INDIVIDUAL VIEW INSIDE FLETBOX

        THIS IS TEMPORARY TO TEST BUT WILL BE REMPLACED BY NESTED FUNCTION

        :param      widget_show:  The widget show
        :type       widget_show:  GET GLOBAL VAR OF MAIN PHONE ATTRIBUTES
        """
                                                                                                                ...
                                                                                                                for _ in tmp_controls_all_node:
                                                                                                                    if _.controls:
                                                                                                                        ...
                                                                                                                        if self.contents__string_node._get_control_name() in list_controls:
                                                                                                                            ...
                                                                                                                            check = self.contents__string_node.controls
                                                                                                                            if not check:
                                                                                                                                self.all_code_list.append(f"{tab_*58}],\n{tab_*56}),), #// CLOSE LAYER 8") #: get widget attributes
                                                                                                                                check          = True
                                                                                                                            ...
                                                                                                                            for _ in tmp_controls_all_node:
                                                                                                                                if _.controls:
                                                                                                                                    ...
                                                                                                                                    if self.contents__string_node._get_control_name() in list_controls:
                                                                                                                                        ...
                                                                                                                                        check = self.contents__string_node.controls
                                                                                                                                        if not check:
                                                                                                                                            self.all_code_list.append(f"{tab_*64}],\n{tab_*62}),), #// CLOSE LAYER 8") #: get widget attributes
                                                                                                                                            check          = True
                                                                                                                                        ...
                                                                                                                                        if check and check_second_10:
                                                                                                                                            ...
                                                                                                                                            #: check_second_99= False

                                                                                                                                        if not check and check_second_10:
                                                                                                                                            self.all_code_list.append(f"{tab_*20}],),), #// LAYER 9 END ")

                                                                                                                            #: LAYER 9
                                                                                                                            if check and check_second_9:
                                                                                                                                self.all_code_list.append(f"{tab_*38}],),), #// LAYER 9 END")
                                                                                                                                #: check_second_99= False
    ...
    def refactoring_attributes_code(self, new_code):
        ...
        new_code = new_code.replace('"onclick":','# "onclick"').replace('"tooltip":','# "tooltip"').replace('null','False')
