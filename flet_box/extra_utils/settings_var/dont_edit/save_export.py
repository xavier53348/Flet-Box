...
class MakeJasonFile():
    ...
    def __init__(self,):
        ...
        # print('=================================================')
        # print(GLOBAL_VAR(get_global_var='EXPORT_DATA_PHONE'))
    ...
    def return_full_code(self, main_node, tab_one=4, tab_two=4, tab_tree=4, check=True):
        ...
        if not self._name_con in list_controls:
            ...
            #: VERY IMPORTANT     def return_full_code(self,main_node,tab_one = 4 ,tab_two=4  ,tab_tree=4 ,check = True):
    ...
    def build_json_file(self, widget_show):
        ...
        # print(">>>>>>>>>>>>>>>===============")
        # for _ in self.all_widgets:
        #     print(self.all_widgets.get(_))
        # print(">>>>>>>>>>>>>>>===============")
        # print(self.all_widgets)
                                                            ...
                                                            if (self.contents__string_node._get_control_name() in list_controls):
                                                                ...
                                                                for _ in tmp_controls_all_node:
                                                                    if _.controls:
                                                                        ...
                                                                        self.contents__string_node = self.main_node.content
                                                                        if self.contents__string_node._get_control_name() in list_control:
                                                                            tmp_controls_all_node = self.contents__string_node.controls
        ...
        self.main_code = self.replace_main_code(code=self.tmp_main_code)
