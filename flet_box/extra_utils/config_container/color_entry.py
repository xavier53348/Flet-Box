...
class ColorEntry(ft.Stack):
                            ...
                            controls=[
                                ...
                                ft.Container(
                                    ...
                                    on_click=lambda x: self.modify_right_container_attributes(
                                        data=self.widget_name, value=ColorEntry
                                    ),
                                ),
                            ],
                        ),
    ...
    def modify_attributes(self, config_widget, value: str = ""):  #: LEFT BUTTON
        ...
        #: SET ATTRIBUTES
        if self.widget_name == "bgcolor":
            self.widget.bgcolor = self.selected_button
        if self.widget_name == "focused_bgcolor":
            self.widget.focused_bgcolor = self.selected_button
        if self.widget_name == "border_color":
            self.widget.border_color = self.selected_button
        if self.widget_name == "focused_border_color":
            self.widget.focused_border_color = self.selected_button
        if self.widget_name == "color":
            self.widget.color = self.selected_button
        if self.widget_name == "icon_color":
            self.widget.icon_color = self.selected_button
        if self.widget_name == "check_color":
            self.widget.check_color = self.selected_button
        if self.widget_name == "fill_color":
            self.widget.fill_color = self.selected_button
