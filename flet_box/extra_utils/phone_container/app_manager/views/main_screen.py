...
class main_screen(ft.DragTarget):
    ...
    def build(self,):
        ...
        list_controls: list = [
            ...
            #: DRAG-BOX-CONTENT [ID: 3004]
            self.draggin_framework(
                content=ft.Container(
                    **self.dict_style("Container_3005"),
                    on_click=lambda dragg_item: self.dragg_event(
                                     selected_widget=dragg_item,),

                    content=ft.Text(
                        **self.dict_style("Text_3006"),
                        # on_click= lambda tmp_widget: event_3006(
                        #        payload="Text_3006",
                        #        page= self.page ),
                    ),
                ),),
            ...
            self.draggin_framework(
                content=ft.Container(
                    **self.dict_style("Container_3011"),
                    ...
                    content=ft.GridView(
                        **self.dict_style("GridView_3012"),
                        controls=[
                        #: DRAG-BOX-CONTENT [ID: 3040]
                        self.draggin_framework(
                            content=ft.Container(
                                **self.dict_style("Container_3041"),
                                on_click=lambda dragg_item: self.dragg_event(
                                                 selected_widget=dragg_item,),

                                content=ft.ElevatedButton(
                                    **self.dict_style("ElevatedButton_3042"),
                                    # on_click= lambda tmp_widget: event_3042(
                                    #        payload="ElevatedButton_3042",
                                    #        page= self.page ),
                                ),
                            ),),]
                    ),
