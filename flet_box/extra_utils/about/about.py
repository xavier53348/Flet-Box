                        ...
                        content=ft.Row(
                            controls=[
                                ft.IconButton(
                                    ...
                                    tooltip="FACEBOOK",
                                    url="https://facebook.com/groups/315046001621078/?mibextid=rS40aB7S9Ucbxw6v",
                                ),
                                ft.IconButton(
                                    icon=ft.icons.DISCORD,
                                    tooltip="@legend_53348#0000",
                                ),
                                ft.IconButton(
                                    icon=ft.icons.CHAT,
                                    tooltip="WHATSAPP GROUP",
                                    url="https://chat.whatsapp.com/ELFB8fSbdMS2chOjXiYAMo",
                                ),
                                ft.IconButton(
                                    icon=ft.icons.EMAIL_ROUNDED,
                                    tooltip="xavier53348@gmail.com",
                                    url="mailto:xavier53348@gmail.com",
                                ),
                                ft.IconButton(
                                    icon=ft.icons.PHONE,
                                    tooltip="(+53) 54448442",
                                ...
                                ft.IconButton(
                                    ...
                                    tooltip="YOUTUBE",
                                    url="https://www.youtube.com/@flet-box",
                                ),
                            ],
                        ),
                    ),  # <=== NOTE COMA
...
class ABOUT_BOX(ft.Stack):
    ...
    def __init__(
        self, header="header", body="body", footer="footer", ref_url="reference"
    ):
        super().__init__()
                    ...
                    ft.Container(
                        ...
                        content=ft.Column(
                            ...
                            controls=[
                                ...
                                ft.Container(
                                    height=4, width=124, bgcolor=ft.colors.TEAL_800
                                ),
                            ],
                        ),
                    ),  # <=== NOTE COMA <==> ERASE COMA IF MAKE 1 ERROR
