            ...
            content=ft.Column(
                controls=[
                    ft.Text(
                        spans=[
                            ft.TextSpan(
                                f"{dictionary_contribution.get('header')}\n\n",
                                ft.TextStyle(
                                    size=18,
                                    color=ft.colors.RED,
                            ...
                            ft.TextSpan(
                                dictionary_contribution.get("body"),
                                ft.TextStyle(
                                    size=15,
...
class CardPrice(ft.Container):
    ...
    def __init__(
        ...
        self.gold_color = (
            ft.colors.YELLOW_ACCENT_400 if self.card_color else ft.colors.BLUE_900
        )

        if self.card_plan == 1:
            self.buy_card = [True, False, False, False, False]
        if self.card_plan == 2:
            self.buy_card = [True, True, False, False, False]
        if self.card_plan == 3:
            self.buy_card = [True, True, True, True, True]
        ...
        self.content = ft.Container(
            ...
            content=ft.Column(
                ...
                controls=[
                    ...
                    ft.Checkbox(
                        label="Core Plataform Features", value=self.buy_card[0]
                    ),
        ...
        self.content = ft.Container(
            ...
            content=ft.Row(
                controls=[
                    ...
                    CardPrice(
                        card_plan=3, card_price=200, card_type="Pro", card_color=True
                    ),
            ...
            content=ft.Column(
                ...
                controls=[
                    ft.Row(
                        ...
                        controls=[
                            ft.Text(
                                value="ERC-20 Matic", size=24, weight=ft.FontWeight.BOLD
                            ),
                            self.alert_dialog,
                        ],
                    ),
                    ft.Row(
                        ...
                        controls=[
                            ft.ElevatedButton(
                                ...
                                on_click=lambda _: self.copy_clipboad(),
                            ),
                            ft.TextButton(
                    ...
                    ft.Text(
                        spans=[
                            ft.TextSpan(
                                "Hello Dev:   You may invite me a beer ;)\n",
                                ft.TextStyle(
                                    size=20,
                                    weight=ft.FontWeight.BOLD,
                        ...
                        content=ft.Column(
                            controls=[
                                ft.ElevatedButton(
                                    ...
                                    elevation=12,
                                    bgcolor=ft.colors.RED_800,
                                    on_click=lambda _: self.edit_box_wallet_address(
                                        wallet_name="Solana",
                                        widget_box=self.box_wallet_addres,
                                    ),
                                ),
                                ft.ElevatedButton(
                                    text="Matic",
...
class SponsorPage(ft.Stack):
    ...
    def validate_click(self):
        ...
        self.donation_page_browser = GLOBAL_VAR(
            get_global_var="DONATION_BROWSER_CONTAINER"
        )
