...
class MenuLeftContainer(ft.Stack):
    ...
    def build(self):
        Drop_MenuLeftContainer = ft.Container(
            ...
            gradient=ft.LinearGradient(
                ...
                colors=[ft.colors.BLACK12, ft.colors.CYAN, ft.colors.BLACK12],
            ),
    ...
    def show_widgets(self, show_widget):
        ...
        if show_widget == "color_browser":
            self.color_browser.visible = (
                True if not self.color_browser.visible else False
            )
    ...
    def on_developing(self, name_seccion):
        ...
        self.data = f"""
          ...
          """
        dlg = ft.AlertDialog(
            title=ft.Text(self.data, size=15),
